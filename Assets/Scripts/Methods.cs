...
public static class Methods
{
    ...
    public static string Notate(this BigDouble number,int normalDigits = 3,int mantissaDigits = 2)
    {
        
        switch (notation)
        {
            case 0: // Standart notation
            ...
            case 3:
                return $"e{BigDouble.Log10(number).ToString($"N{mantissaDigits}")}";
            default:
                return "";
        }
    }
